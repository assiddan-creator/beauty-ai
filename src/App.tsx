...
const STYLES: Array<{
...
}> = [
  {
    ...
    icon: Waves,
    prompt: 'Virtual staging, living room. Mediterranean style furniture, low-level curved sofas, terracotta decor accents, indoor plants, natural sunlight. Movie Look: Call Me By Your Name. Camera: Sony Venice. Lens: Prime 35mm. Film: Kodak Portra. Elements: Preserve original architecture, photorealistic.',
  },
  {
    id: 'modern-farmhouse',
    ...
    icon: Leaf,
    prompt: 'Virtual staging, interior design. Oversized cozy linen sofas, reclaimed natural wood furniture, farmhouse decor, rustic lighting fixtures. Movie Look: Little Women. Camera: ARRI Alexa 65. Lens: Prime 24mm. Film: Kodak Portra. Elements: Warm inviting lighting, preserve structural integrity.',
  },
  {
    id: 'mid-century',
  ...
  },
  {
    ...
    icon: Crown,
    prompt: 'Virtual staging, boutique hotel style. Matte velvet sofa, elegant dark wood furniture, minimal premium decor, ambient cove lighting. Movie Look: Succession. Camera: ARRI Alexa 65. Lens: Prime 85mm. Film: Cinestill 800T. Elements: Sophisticated, premium materials, untouched architecture.',
  },
  {
    id: 'wabi-sabi',
    ...
    icon: Snowflake,
    prompt: 'Virtual staging, minimalist zen retreat. Low wooden furniture, soft neutral rugs, perfectly imperfect ceramic decor, diffused lighting. Movie Look: Dune (Interiors). Camera: Sony Venice. Lens: Prime 35mm. Film: Kodak Portra. Elements: Peaceful atmosphere, preserve original room.',
  },
  {
    id: 'boho-chic',
    name: 'Boho-Chic',
  ...
  },
  {
    ...
    icon: Building2,
    prompt: 'Virtual staging, loft style. Dark metallic furniture, distressed leather couch, sleek glass tables, subtle warm Edison bulb lamps. Movie Look: The Batman. Camera: Sony Venice. Lens: Anamorphic. Film: Cinestill 800T. Elements: Moody cinematic depth, preserve architecture.',
  },
  {
    id: 'rustic-cabin',
    ...
    icon: Leaf,
    prompt: 'Virtual staging, luxury rustic style. Raw natural wood edge coffee table, deep green velvet sofa, cozy woven throw blankets. Movie Look: The Revenant. Camera: ARRI Alexa 65. Lens: Prime 35mm. Film: Kodak Portra. Elements: Deep depth of field, natural vibe, preserve layout.',
  },
  {
    id: 'clean-modern',
    name: 'Clean Modern',
    ...
    icon: Sparkles,
    prompt: 'Virtual staging, minimalist modern interior. Low-profile linen sofa, uncluttered modern furniture, light oak wood decor. Movie Look: Her. Camera: ARRI Alexa 65. Lens: Prime 24mm. Film: Kodak Portra. Elements: Maximum light and space, preserve original architecture exactly.',
  },
  {
    ...
    icon: Snowflake,
    prompt: 'Virtual staging, Scandinavian hygge interior. Birch wood furniture, cozy wool textiles, potted plants, minimalistic decor. Movie Look: Force Majeure. Camera: Sony Venice. Lens: Prime 35mm. Film: Kodak Portra. Elements: Calm bright atmosphere, preserve room structure completely.',
  },
  {
    id: 'hamptons-coastal',
    ...
    icon: Waves,
    prompt: 'Virtual staging, luxury Hamptons coastal interior. Navy and sand palette furniture, linen sofas, natural fiber rugs, elegant decor. Movie Look: The Talented Mr. Ripley. Camera: ARRI Alexa 65. Lens: Prime 35mm. Film: Kodak Portra. Elements: Aspirational lifestyle, preserve all structural elements.',
  },
  {
    id: 'timeless-classic',
    ...
    icon: Crown,
    prompt: 'Virtual staging, traditional elegant interior. Refined upholstered furniture, classic art pieces, symmetrical furniture layout, muted tone rugs. Movie Look: The Crown. Camera: ARRI Alexa 65. Lens: Prime 50mm. Film: Cinestill 800T. Elements: Sophisticated and calm, preserve architecture perfectly.',
  },
  {
    ...
    icon: ArrowLeftRight,
    prompt: 'Virtual staging, compact modern interior. Space-saving modular furniture, area rugs for zoning, modern floor lamps. Movie Look: Lost in Translation. Camera: Sony Venice. Lens: Prime 24mm. Film: Kodak Portra. Elements: Maximum sense of space, preserve all walls and windows exactly.',
  },
  {
    id: 'art-deco-glamour',
    ...
    icon: Crown,
    prompt: 'Virtual staging, Art Deco luxury interior. Velvet furniture, gold accents, geometric pattern rugs, mirrored decor surfaces. Movie Look: The Great Gatsby. Camera: ARRI Alexa 65. Lens: Prime 35mm. Film: Cinestill 800T. Elements: Glamorous and bold, preserve original room layout.',
  },
  {
    id: 'french-country',
    name: 'French Country',
    ...
    icon: Leaf,
    prompt: 'Virtual staging, French country interior. Distressed wood furniture, soft linen upholstery, lavender accents, warm candlelight decor. Movie Look: Amelie. Camera: Sony Venice. Lens: Prime 35mm. Film: Kodak Portra. Elements: Romantic and warm, preserve room architecture.',
  },
  {
    id: 'tokyo-minimal',
    name: 'Tokyo Minimal',
    ...
    icon: Snowflake,
    prompt: 'Virtual staging, Japanese urban minimal interior. Tatami-inspired low furniture, bonsai plant, minimal stone decor pieces. Movie Look: Lost in Translation lobby. Camera: Sony Venice. Lens: Prime 50mm. Film: Kodak Portra. Elements: Serene and precise, preserve all architecture.',
  },
  {
    ...
    icon: Crown,
    prompt: 'Virtual staging, Hollywood Regency interior. Lacquered furniture, plush velvet seating, brass accents, dramatic floor lamps. Movie Look: Feud: Bette and Joan. Camera: ARRI Alexa 65. Lens: Prime 35mm. Film: Cinestill 800T. Elements: Dramatic and luxurious, preserve room structure.',
  },
  {
    id: 'new-york-loft',
    name: 'New York Loft',
    ...
    icon: Building2,
    prompt: 'Virtual staging, New York city loft interior. Distressed leather couch, black steel frame furniture, reclaimed wood tables, urban decor. Movie Look: Friends apartment modernized. Camera: Sony Venice. Lens: Anamorphic. Film: Kodak Portra. Elements: Urban and lived-in, preserve architecture.',
  },
  {
    id: 'resort-bali',
    name: 'Bali Resort',
    ...
    icon: Waves,
    prompt: 'Virtual staging, Balinese resort interior. Teak wood furniture, tropical indoor plants, rattan accents, warm lantern lamps. Movie Look: Eat Pray Love. Camera: ARRI Alexa 65. Lens: Prime 35mm. Film: Kodak Portra. Elements: Tropical and serene, preserve room layout exactly.',
  },
  {
    id: 'dark-moody',
    name: 'Dark Moody',
    ...
    icon: Palette,
    prompt: 'Virtual staging, moody dark interior. Dark velvet sofa, brass lighting fixtures, deep forest green decor accents, layered rugs. Movie Look: Peaky Blinders. Camera: Sony Venice. Lens: Prime 35mm. Film: Cinestill 800T. Elements: Rich and atmospheric, preserve architecture.',
  },
  {
    ...
    icon: Waves,
    prompt: 'Virtual staging, Mediterranean villa interior. Rustic wood furniture, mosaic decor accents, wrought iron lamps, terracotta vases. Movie Look: Under the Tuscan Sun. Camera: ARRI Alexa 65. Lens: Prime 24mm. Film: Kodak Portra. Elements: Sun-drenched and authentic, preserve architecture.',
  },
  {
    id: 'zen-spa',
    name: 'Zen Spa',
    image: '/Zen-Spa.jpg',
    icon: Snowflake,
    prompt: 'Virtual staging, luxury spa retreat interior. Bamboo furniture accents, white linen towels, indoor tabletop water feature, pebble decor. Movie Look: Crazy Rich Asians spa. Camera: Sony Venice. Lens: Prime 50mm. Film: Kodak Portra. Elements: Healing and calm, preserve room structure.',
  },
  {
    id: 'parisian-chic',
    name: 'Parisian Chic',
    ...
    icon: Crown,
    prompt: 'Virtual staging, Parisian apartment interior. Velvet armchairs, vintage gold framed mirrors, soft grey area rugs, chic elegant furniture. Movie Look: Midnight in Paris. Camera: ARRI Alexa 65. Lens: Prime 35mm. Film: Kodak Portra. Elements: Effortlessly elegant, preserve all architecture.',
  },
  {
    id: 'desert-southwest',
    ...
    icon: Leaf,
    prompt: 'Virtual staging, Southwestern desert interior. Navajo-pattern rugs, terracotta pots, cacti plants, warm sienna furniture accents. Movie Look: Breaking Bad house reimagined. Camera: Sony Venice. Lens: Prime 35mm. Film: Kodak Portra. Elements: Earthy and warm, preserve architecture.',
  },
  {
    ...
    icon: Palette,
    prompt: 'Virtual staging, maximalist eclectic interior. Layered pattern rugs, global art objects, mixed era furniture, curated decorative clutter. Movie Look: The Royal Tenenbaums. Camera: ARRI Alexa 65. Lens: Prime 24mm. Film: Kodak Portra. Elements: Curated and personal, preserve room layout.',
  },
  {
    id: 'organic-modern',
    name: 'Organic Modern',
    ...
    icon: Leaf,
    prompt: 'Virtual staging, organic modern interior. Curved furniture, natural stone coffee table, bouclé fabrics, dried pampas grass vases. Movie Look: Marriage Story apartment. Camera: Sony Venice. Lens: Prime 35mm. Film: Kodak Portra. Elements: Soft and natural, preserve original architecture.',
  },
  {
    id: 'miami-modern',
    name: 'Miami Modern',
    ...
    icon: Waves,
    prompt: 'Virtual staging, Miami luxury modern interior. White lacquer furniture, tropical art pieces, coral and turquoise decor pillows. Movie Look: Bloodline. Camera: ARRI Alexa 65. Lens: Prime 24mm. Film: Kodak Portra. Elements: Bright and luxurious, preserve architecture.',
  },
  {
    id: 'brutalist-chic',
    name: 'Brutalist Chic',
    ...
    icon: Building2,
    prompt: 'Virtual staging, brutalist chic interior. Statement sculptural furniture, dark minimalist decor, architectural floor lamps. Movie Look: Ex Machina. Camera: Sony Venice. Lens: Prime 50mm. Film: Cinestill 800T. Elements: Bold and architectural, preserve all structural surfaces.',
  },
  {
    id: 'cottagecore',
    name: 'Cottagecore',
    ...
    icon: Leaf,
    prompt: 'Virtual staging, cottagecore interior. Vintage wood furniture, floral fabric cushions, dried flower vases, cozy layered textiles. Movie Look: Midsommar cottage. Camera: ARRI Alexa 65. Lens: Prime 35mm. Film: Kodak Portra. Elements: Whimsical and cozy, preserve room architecture.',
  },
  {
    id: 'luxury-penthouse',
    ...
    icon: Crown,
    prompt: 'Virtual staging, ultra-luxury penthouse interior. Bespoke modern furniture, statement chandelier, marble surface tables, monochromatic luxury rugs. Movie Look: Succession finale apartment. Camera: ARRI Alexa 65. Lens: Prime 85mm. Film: Cinestill 800T. Elements: Ultra-premium, preserve all architecture exactly.',
  },
]
