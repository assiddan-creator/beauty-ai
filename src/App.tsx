...
const STYLES: Array<{
  ...
  },
  {
    ...
    icon: Sparkles,
    prompt: 'Virtual staging, minimalist modern interior. White walls, light oak floors, low-profile linen sofa, uncluttered layout. Movie Look: Her. Camera: ARRI Alexa 65. Lens: Prime 24mm. Film: Kodak Portra. Elements: Maximum light and space, preserve original architecture exactly.',
  },
  {
    ...
    icon: Snowflake,
    prompt: 'Virtual staging, Scandinavian hygge interior. White walls, birch wood furniture, cozy wool textiles, potted plants. Movie Look: Force Majeure. Camera: Sony Venice. Lens: Prime 35mm. Film: Kodak Portra. Elements: Calm bright atmosphere, preserve room structure completely.',
  },
  {
    id: 'hamptons-coastal',
    ...
    icon: Waves,
    prompt: 'Virtual staging, luxury Hamptons coastal interior. White paneled walls, navy and sand palette, linen sofas, natural fiber rugs. Movie Look: The Talented Mr. Ripley. Camera: ARRI Alexa 65. Lens: Prime 35mm. Film: Kodak Portra. Elements: Aspirational lifestyle, preserve all structural elements.',
  },
  {
    id: 'timeless-classic',
    ...
    icon: Crown,
    prompt: 'Virtual staging, traditional elegant interior. Symmetrical layout, refined upholstered furniture, muted tones, classic art. Movie Look: The Crown. Camera: ARRI Alexa 65. Lens: Prime 50mm. Film: Cinestill 800T. Elements: Sophisticated and calm, preserve architecture perfectly.',
  },
  {
    ...
    icon: ArrowLeftRight,
    prompt: 'Virtual staging, compact modern interior. Space-saving modular furniture, clear circulation, zoning with rugs and lighting. Movie Look: Lost in Translation. Camera: Sony Venice. Lens: Prime 24mm. Film: Kodak Portra. Elements: Maximum sense of space, preserve all walls and windows exactly.',
  },
  {
    id: 'art-deco-glamour',
    ...
    icon: Crown,
    prompt: 'Virtual staging, Art Deco luxury interior. Gold accents, geometric patterns, velvet furniture, mirrored surfaces, bold symmetry. Movie Look: The Great Gatsby. Camera: ARRI Alexa 65. Lens: Prime 35mm. Film: Cinestill 800T. Elements: Glamorous and bold, preserve original room layout.',
  },
  {
    id: 'french-country',
    name: 'French Country',
    ...
    icon: Leaf,
    prompt: 'Virtual staging, French country interior. Soft linen upholstery, distressed wood furniture, toile patterns, lavender accents, warm candlelight. Movie Look: Amelie. Camera: Sony Venice. Lens: Prime 35mm. Film: Kodak Portra. Elements: Romantic and warm, preserve room architecture.',
  },
  {
    id: 'tokyo-minimal',
    name: 'Tokyo Minimal',
    ...
    icon: Snowflake,
    prompt: 'Virtual staging, Japanese urban minimal interior. Tatami-inspired low furniture, shoji screen accents, bonsai, neutral stone palette. Movie Look: Lost in Translation lobby. Camera: Sony Venice. Lens: Prime 50mm. Film: Kodak Portra. Elements: Serene and precise, preserve all architecture.',
  },
  {
    ...
    icon: Crown,
    prompt: 'Virtual staging, Hollywood Regency interior. Bold jewel tones, lacquered furniture, brass accents, plush velvet, dramatic lighting. Movie Look: Feud: Bette and Joan. Camera: ARRI Alexa 65. Lens: Prime 35mm. Film: Cinestill 800T. Elements: Dramatic and luxurious, preserve room structure.',
  },
  {
    id: 'new-york-loft',
    name: 'New York Loft',
    ...
    icon: Building2,
    prompt: 'Virtual staging, New York city loft interior. Exposed brick, high ceilings emphasized, concrete accents, black steel frames, leather and wood. Movie Look: Friends apartment modernized. Camera: Sony Venice. Lens: Anamorphic. Film: Kodak Portra. Elements: Urban and lived-in, preserve architecture.',
  },
  {
    id: 'resort-bali',
    name: 'Bali Resort',
    ...
    icon: Waves,
    prompt: 'Virtual staging, Balinese resort interior. Teak wood furniture, tropical plants, rattan accents, stone textures, warm lantern lighting. Movie Look: Eat Pray Love. Camera: ARRI Alexa 65. Lens: Prime 35mm. Film: Kodak Portra. Elements: Tropical and serene, preserve room layout exactly.',
  },
  {
    id: 'dark-moody',
    name: 'Dark Moody',
    ...
    icon: Palette,
    prompt: 'Virtual staging, moody dark interior. Deep forest green walls implied through furniture, dark velvet sofa, brass fixtures, warm dim lighting, layered rugs. Movie Look: Peaky Blinders. Camera: Sony Venice. Lens: Prime 35mm. Film: Cinestill 800T. Elements: Rich and atmospheric, preserve architecture.',
  },
  {
    ...
    icon: Waves,
    prompt: 'Virtual staging, Mediterranean villa interior. Arched details emphasized, terracotta tiles, whitewashed walls, mosaic accents, wrought iron. Movie Look: Under the Tuscan Sun. Camera: ARRI Alexa 65. Lens: Prime 24mm. Film: Kodak Portra. Elements: Sun-drenched and authentic, preserve architecture.',
  },
  {
    id: 'zen-spa',
    name: 'Zen Spa',
    image: '/Zen-Spa.jpg',
    icon: Snowflake,
    prompt: 'Virtual staging, luxury spa retreat interior. Natural stone, bamboo accents, white linen, candles, indoor water feature suggestion, pebble textures. Movie Look: Crazy Rich Asians spa. Camera: Sony Venice. Lens: Prime 50mm. Film: Kodak Portra. Elements: Healing and calm, preserve room structure.',
  },
  {
    id: 'parisian-chic',
    name: 'Parisian Chic',
    ...
    icon: Crown,
    prompt: 'Virtual staging, Parisian apartment interior. Herringbone floors emphasized, marble fireplace, classic moldings highlighted, velvet armchairs, soft grey palette. Movie Look: Midnight in Paris. Camera: ARRI Alexa 65. Lens: Prime 35mm. Film: Kodak Portra. Elements: Effortlessly elegant, preserve all architecture.',
  },
  {
    id: 'desert-southwest',
    ...
    icon: Leaf,
    prompt: 'Virtual staging, Southwestern desert interior. Adobe-inspired textures, terracotta pots, Navajo-pattern rugs, cacti, warm sienna and turquoise accents. Movie Look: Breaking Bad house reimagined. Camera: Sony Venice. Lens: Prime 35mm. Film: Kodak Portra. Elements: Earthy and warm, preserve architecture.',
  },
  {
    ...
    icon: Palette,
    prompt: 'Virtual staging, maximalist eclectic interior. Layered patterns, global art objects, mixed furniture eras, bold wallpaper suggestion, curated clutter. Movie Look: The Royal Tenenbaums. Camera: ARRI Alexa 65. Lens: Prime 24mm. Film: Kodak Portra. Elements: Curated and personal, preserve room layout.',
  },
  {
    id: 'organic-modern',
    name: 'Organic Modern',
    ...
    icon: Leaf,
    prompt: 'Virtual staging, organic modern interior. Curved furniture, natural stone coffee table, bouclé fabrics, dried pampas grass, warm ivory tones. Movie Look: Marriage Story apartment. Camera: Sony Venice. Lens: Prime 35mm. Film: Kodak Portra. Elements: Soft and natural, preserve original architecture.',
  },
  {
    id: 'miami-modern',
    name: 'Miami Modern',
    ...
    icon: Waves,
    prompt: 'Virtual staging, Miami luxury modern interior. White lacquer furniture, tropical art, pops of coral and turquoise, terrazzo floors emphasized, open and airy. Movie Look: Bloodline. Camera: ARRI Alexa 65. Lens: Prime 24mm. Film: Kodak Portra. Elements: Bright and luxurious, preserve architecture.',
  },
  {
    id: 'brutalist-chic',
    name: 'Brutalist Chic',
    ...
    icon: Building2,
    prompt: 'Virtual staging, brutalist chic interior. Raw concrete textures emphasized, statement sculptural furniture, monochrome palette, architectural lighting. Movie Look: Ex Machina. Camera: Sony Venice. Lens: Prime 50mm. Film: Cinestill 800T. Elements: Bold and architectural, preserve all structural surfaces.',
  },
  {
    id: 'cottagecore',
    name: 'Cottagecore',
    ...
    icon: Leaf,
    prompt: 'Virtual staging, cottagecore interior. Floral fabrics, vintage wood furniture, dried flowers, soft pastel palette, cozy layered textiles, antique accents. Movie Look: Midsommar cottage. Camera: ARRI Alexa 65. Lens: Prime 35mm. Film: Kodak Portra. Elements: Whimsical and cozy, preserve room architecture.',
  },
  {
    id: 'luxury-penthouse',
    ...
    icon: Crown,
    prompt: 'Virtual staging, ultra-luxury penthouse interior. Statement chandelier, floor-to-ceiling emphasis, marble surfaces, bespoke furniture, monochromatic luxury palette. Movie Look: Succession finale apartment. Camera: ARRI Alexa 65. Lens: Prime 85mm. Film: Cinestill 800T. Elements: Ultra-premium, preserve all architecture exactly.',
  },
]
